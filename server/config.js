...
const config = {
  ...
  previousCloseRate: Number(process.env.PREVIOUS_CLOSE_RATE || 0),
  previousCloseDate: process.env.PREVIOUS_CLOSE_DATE || '',
  previousCloseSource: process.env.PREVIOUS_CLOSE_SOURCE || 'Environment previous close',
